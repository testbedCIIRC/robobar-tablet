...
<div class="drinkGridContainer">
  <button class="drinkGroupButton">
    <div class="text"><span>Beer</span></div>
    <div class="icons">
      <BeakerIconSvg /> 300ml
    </div>
  </button>
  <button class="drinkGroupButton">
    <div class="text"><span>Wine</span></div>
    <div class="icons">
      <BeakerIconSvg /> 200ml
    </div>
  </button>
...
<script>
import BeakerIconSvg from '../svg-components/BeakerIconSvg.vue';
